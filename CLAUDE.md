...
| `docs/adr/` | 24 Architecture Decision Records (append-only); see `README.md` there for the index |
...
# through v_fact_run_secured — see dashboards/metabase/README.md, ADR-0024
