...
| [0004](0004-aws-cdk-batch-fargate.md) | Deploy on AWS via CDK + Batch/Fargate | Accepted |
| [0005](0005-insert-only-postgres.md) | Store results in an insert-only PostgreSQL schema | Accepted |
